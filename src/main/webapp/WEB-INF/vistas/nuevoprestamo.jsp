...
<body>
	...
	<div class="container">
		<form:form action="validar-nuevo-prestamo" method="POST"
			modelAttribute="afiliado" name="frmPrestamo">
					...
					<div class="col-lg-10">
						<select name="nombreF" id="nombreF" class="form-control">
							...
							<c:forEach items="${financieras}" var="lista">
								<option value="${lista.nombre}">${lista.nombre}
									(${lista.montoCapital})</option>
							</c:forEach>
